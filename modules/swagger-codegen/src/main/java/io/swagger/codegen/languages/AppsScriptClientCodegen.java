...
public class AppsScriptClientCodegen extends DefaultCodegen implements CodegenConfig {
    ...
    public AppsScriptClientCodegen() {
        ...
        // binary not supported in AppsScript client right now, using String as a workaround
    ...
    public CodegenModel fromModel(String name, Model model, Map<String, Model> allDefinitions) {
        ...
        if (allDefinitions != null && codegenModel != null && codegenModel.parent != null && codegenModel.hasEnums) {
            ...
            codegenModel = AppsScriptClientCodegen.reconcileInlineEnums(codegenModel, parentCodegenModel);
        }
